...
public class LendingRecordDto {
    ...
    private String recordOwnerEmail; // Changed from int to String to use email
     ...
     * @param recordOwnerEmail The email of the game owner
     */
    public LendingRecordDto(int id, Date startDate, Date endDate, String status, int borrowRequestId, String recordOwnerEmail) {
        this.id = id;
    ...
    public String getRecordOwnerEmail() { return recordOwnerEmail; }
