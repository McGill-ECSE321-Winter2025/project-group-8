...
import MyEvent from "@/components/dashboard-page/MyEvent.jsx";
...
export default function DashboardMyEvents() {
  ...
  return <TabsContent value="myevents" className="space-y-6">
    <div className="flex justify-between items-center">
      <h2 className="text-2xl font-bold">My Upcoming Events</h2>
      <Button>Create Event</Button>
    </div>
    <div className="space-y-4">
      { dummyEvents.map(event => <MyEvent key={event.id} {...event} />)}
    </div>
  </TabsContent>
}